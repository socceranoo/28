...
public class Rank implements Comparable {
   ...
   private static boolean trumpRules = true;
    
   /** 
    * The rank ace. 
    */
   public final static Rank ACE = new Rank( "Ace", "a" , 0, 1);
   /** 
    * The rank two. 
    */
   public final static Rank TWO = new Rank( "Two", "2" , 1, 10);
   /** 
    * The rank three. 
    */
   public final static Rank THREE = new Rank( "Three", "3", 2, 5);
   /** 
    * The rank four. 
    */
   public final static Rank FOUR = new Rank( "Four", "4" , 3, 0);
   /**
    * The rank five.
    */
   public final static Rank FIVE = new Rank( "Five", "5" , 4, 0);
   /**
    * The rank six.
    */
   public final static Rank SIX = new Rank( "Six", "6" , 5, 0);
   /** 
    * The rank seven.
    */
   public final static Rank SEVEN = new Rank( "Seven", "7" , 6, 0);
   /**
    * The rank eight.
    */
   public final static Rank EIGHT = new Rank( "Eight", "8" , 7, 0 );
   /**
    * The rank nine.
    */
   public final static Rank NINE = new Rank( "Nine", "9" , 8, 2);
   /**
    * The rank ten.
    */
   public final static Rank TEN = new Rank( "Ten", "t" , 9, 1);
   /**
    * The rank jack.
    */
   public final static Rank JACK = new Rank( "Jack", "j" , 10, 3);
   /**
    * The rank queen.
    */
   public final static Rank QUEEN = new Rank( "Queen", "q" , 11, 0);
   /**
    * The rank king.
    */
   public final static Rank KING = new Rank( "King", "k" , 12, 0);
   ...
   private final static java.util.List VALUES_28 =
      Collections.unmodifiableList( Arrays.asList( new Rank[] { JACK, NINE, ACE, TEN, KING, QUEEN, EIGHT, SEVEN } ) );

   private final static java.util.List VALUES_28_short =
      Collections.unmodifiableList( Arrays.asList( new Rank[] { JACK, NINE, ACE, TEN} ) );

   private final static java.util.List VALUES_48 =
      Collections.unmodifiableList( Arrays.asList( new Rank[] { THREE, JACK, NINE, ACE, TEN, KING, QUEEN, EIGHT, SEVEN } ) );

   private final static java.util.List VALUES_88 =
      Collections.unmodifiableList( Arrays.asList( new Rank[] { TWO, THREE, JACK, NINE, ACE, TEN, KING, QUEEN, EIGHT, SEVEN } ) );
   ...
   */
   public final static java.util.List VALUES =
      Collections.unmodifiableList( VALUES_28_short );
   
   
   // Constructor - declared private as only the predefined values should
   // be used by the client.
   private Rank( String nameValue, String symbolValue, int idx, int value ) {
      name = nameValue;
      symbol = symbolValue;
      index = idx;
	trumpValue = value;
   ...
   */
   ...
   public static void setTrumpRules(boolean temp) {
	trumpRules = temp;
   }
