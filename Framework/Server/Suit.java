...
public final class Suit implements Comparable {
    ...
    * The suit clubs.
    */
   public final static Suit CLUBS = new Suit( "Clubs", "c" , 0);
   /**
    * The suit diamonds.
    */
   public final static Suit DIAMONDS = new Suit( "Diamonds", "d" , 1);
   /**
    * The suit hearts.
    */
   public final static Suit HEARTS = new Suit( "Hearts", "h" , 2);
   /**
    * The suit spades.
    */
   public final static Suit SPADES = new Suit( "Spades", "s", 3);
   ...
   */
   ...
   private Suit( String nameValue, String symbolValue, int idx) {
      name = nameValue;
      symbol = symbolValue;
	index = idx;
   }
